...
- Representativeness for real customers and transactions was not tested.
- Loss reduction, customer experience, fairness/regulatory suitability, and online serving/monitoring performance were not measured.
- Next steps: enrich features for the weak segment, rerun time-based validation, and review operational metrics and fairness.
